...
- `.claude/gtmos/references/spam-words.md` — banned wording + safe rewrites (load before writing or QA-ing copy)
- `.claude/gtmos/references/spintax.md` — deliverability spintax rules (load before shipping)
...
- `.claude/gtmos/references/experiment-design.md` — single-variable experiment framework (load before iterating)
- `.claude/gtmos/references/weekly-rhythm.md` — operating cadence (load for daily/weekly planning)
