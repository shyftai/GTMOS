...
---
<objective>
Manage GTMOS collaboration mode. Set up Supabase connection, check status, invite users, or sync local data to the shared database.
...
## Action: setup
1. Display mode header: `<< GTMOS // COLLABORATION SETUP >>`
...
## Action: status
1. Display mode header: `<< GTMOS // COLLABORATION STATUS >>`
...
## Action: invite
1. Display mode header: `<< GTMOS // INVITE USER >>`
...
## Action: sync
1. Display mode header: `<< GTMOS // SYNC TO SUPABASE >>`
