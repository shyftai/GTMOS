...
4. Generate report with these sections:
   ...
   **Weekly report:**
   ...
   - **Positive reply rate** (positive replies / total sent) — the headline metric, with benchmark comparison (≥1% good, ≥2% great); pull via `/gtm:reply-score` / `positive-reply-scoring.md`
