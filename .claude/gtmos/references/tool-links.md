...
When referencing a tool's website, use the link from this file. The `?ref=gtmos` tag tracks referrals — these may be swapped for affiliate links later. One file to update, every command picks it up.
...
- Openmart: https://openmart.com?ref=gtmos
...
### Lookalike Discovery
- Ocean.io: https://ocean.io?ref=gtmos
- DiscoLike: https://discolike.com?ref=gtmos
...
- These links may be updated to affiliate links in the future
